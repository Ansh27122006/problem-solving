package advanced.dsa;

import java.util.Scanner;

public class Coursera {

    public static String removeOccurrences(String str1, String str2) {
    ...
    public static void main(String[] args) {
        ...
        String result = removeOccurrences(s1.toString(), s2);
        System.out.println("\nResult:");
